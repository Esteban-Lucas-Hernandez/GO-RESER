...
import { PerfilService } from '../../../features/public/profile/profile.service';
import { UsuarioDTO } from '../../models/user.model';
...
@Component({
  ...
  templateUrl: './nav-alt.component.html',
  styleUrls: ['./nav-alt.component.css'],
})
